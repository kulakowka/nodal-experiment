module.exports = (function() {
  ...
  const ControllerNameController = Nodal.require('app/controllers/controller_name_controller.js');
  const ModelNamesController = Nodal.require('app/controllers/model_names_controller.js');
  ...
  router.route('/controller_name/{id}').use(ControllerNameController);
  router.route('/model_names/{id}').use(ModelNamesController);
